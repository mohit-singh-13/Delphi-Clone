...
const Chat = () => {
    ...
    return (
        <div className="bg-gray-300 h-screen w-11/12 max-w-[1210px] mx-auto relative max-h-max">
            ...
            <div className="flex gap-2 fixed bottom-5 w-[79%]">
                <input type="text" name="messages" id="messages" placeholder="type your message" className="w-[95%] placeholder:text-[1.1rem] p-5 rounded-lg border border-black" onChange={changeHandler} onKeyDown={keyHandler} value={text}/>
